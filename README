...
ii) Once inside the program, hit mission
iii) Set departure and destination
iv) Set Launch Window
v) Select your ship
vi) Set payload mass
vii) Once everything is set, hit Launch
viii) Watch the trade happen in real time
